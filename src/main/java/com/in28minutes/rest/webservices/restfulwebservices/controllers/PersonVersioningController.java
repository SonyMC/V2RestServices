...
public class PersonVersioningController {
	...
	// uri versioning which uses different uris for different versions of the service 
	...
	// Request param versioning which uses param value ( /params?version=nnn) for different versions of the service 
	...
	// Media type versioning/produces versioning which uses produces value ( /headers and supply values in header using postman or some other tool) for different versions of the service 
	@GetMapping(value="/person/produces", produces="application/Sony.app-v1+json")
	public PersonV1 producesV1(){
		return new PersonV1("Amitabh Bachan");
	}
	
	// MediaType  versioning/produces versioning which uses produces value ( /headers and supply values in header using postman or some other tool) for different versions of the service 
